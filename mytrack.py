...
@torch.no_grad()
def run(
        source='/content/people_walkingvid.mp4',
        yolo_weights='/content/Yolov7_StrongSORT_OSNet/yolov7.pt',  # model.pt path(s),
        strong_sort_weights='/content/Yolov7_StrongSORT_OSNet/osnet_x0_25_msmt17.pt',  # model.pt path,
        config_strongsort='/content/Yolov7_StrongSORT_OSNet/strong_sort/configs/strong_sort.yaml',
        project='/content/Yolov7_StrongSORT_OSNet/optrackerop',  # save results to project/name
        name='expnew',  # save results to project/name
